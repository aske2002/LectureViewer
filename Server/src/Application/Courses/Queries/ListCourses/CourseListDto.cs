...
public record CourseListDto : BaseResponse<CourseId>
{
    ...
    public required List<PublicUser> Instructors { get; init; } = new List<PublicUser>();
    public required int LecturesCount { get; init; }
    ...
    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap<Course, CourseListDto>()
                ...
                .ForMember(dest => dest.LecturesCount,
                    opt => opt.MapFrom(src => src.Lectures.Count));
