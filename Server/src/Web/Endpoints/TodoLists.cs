...
public class TodoLists : EndpointGroupBase
{
    ...
    public async Task<Created<TodoListId>> CreateTodoList(ISender sender, CreateTodoListCommand command)
    {
    ...
    public async Task<Results<NoContent, BadRequest>> UpdateTodoList(ISender sender, TodoListId id, UpdateTodoListCommand command)
    {
    ...
    public async Task<NoContent> DeleteTodoList(ISender sender, TodoListId id)
    {
